...
public class StanPrintableImpl extends ASTWrapperPsiElement implements StanPrintable {

  public StanPrintableImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitPrintable(this);
  }
  ...
  public StanStringLiteral getStringLiteral() {
    return findChildByClass(StanStringLiteral.class);
  }
