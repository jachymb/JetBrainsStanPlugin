...
public class StanTopDeclaredVarImpl extends ASTWrapperPsiElement implements StanTopDeclaredVar {

  public StanTopDeclaredVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitTopDeclaredVar(this);
  }
