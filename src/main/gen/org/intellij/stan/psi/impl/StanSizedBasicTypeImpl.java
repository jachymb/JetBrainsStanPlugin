...
public class StanSizedBasicTypeImpl extends ASTWrapperPsiElement implements StanSizedBasicType {

  public StanSizedBasicTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitSizedBasicType(this);
  }
