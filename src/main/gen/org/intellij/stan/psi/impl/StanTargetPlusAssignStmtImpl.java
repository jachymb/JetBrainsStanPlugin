...
public class StanTargetPlusAssignStmtImpl extends ASTWrapperPsiElement implements StanTargetPlusAssignStmt {

  public StanTargetPlusAssignStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitTargetPlusAssignStmt(this);
  }
