...
public class StanCondDistExprImpl extends ASTWrapperPsiElement implements StanCondDistExpr {

  public StanCondDistExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitCondDistExpr(this);
  }
