...
public class StanUnsizedBasicTypeImpl extends ASTWrapperPsiElement implements StanUnsizedBasicType {

  public StanUnsizedBasicTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitUnsizedBasicType(this);
  }
