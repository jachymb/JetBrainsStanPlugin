...
public class StanIndexExprImpl extends ASTWrapperPsiElement implements StanIndexExpr {

  public StanIndexExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StanIndexList getIndexList() {
    return findChildByClass(StanIndexList.class);
  }

  @Override
  @Nullable
  public StanPrimaryExpr getPrimaryExpr() {
    return findChildByClass(StanPrimaryExpr.class);
  }
