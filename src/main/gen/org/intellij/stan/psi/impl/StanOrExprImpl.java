...
public class StanOrExprImpl extends ASTWrapperPsiElement implements StanOrExpr {

  public StanOrExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public StanAndExpr getAndExpr() {
    return findNotNullChildByClass(StanAndExpr.class);
  }

  @Override
  @Nullable
  public StanOrExpr getOrExpr() {
    return findChildByClass(StanOrExpr.class);
  }
