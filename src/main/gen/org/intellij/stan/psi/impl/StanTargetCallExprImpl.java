...
public class StanTargetCallExprImpl extends ASTWrapperPsiElement implements StanTargetCallExpr {

  public StanTargetCallExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitTargetCallExpr(this);
  }
