...
public class StanUnaryExprImpl extends ASTWrapperPsiElement implements StanUnaryExpr {

  public StanUnaryExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public StanUnaryExpr getUnaryExpr() {
    return findChildByClass(StanUnaryExpr.class);
  }
