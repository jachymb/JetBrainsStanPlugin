...
public class StanIntLiteralExprImpl extends ASTWrapperPsiElement implements StanIntLiteralExpr {

  public StanIntLiteralExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getIntnumeral() {
    return findNotNullChildByType(INTNUMERAL);
  }
