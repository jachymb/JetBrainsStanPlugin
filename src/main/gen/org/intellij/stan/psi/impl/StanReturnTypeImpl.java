...
public class StanReturnTypeImpl extends ASTWrapperPsiElement implements StanReturnType {

  public StanReturnTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  public StanUnsizedType getUnsizedType() {
    return findChildByClass(StanUnsizedType.class);
  }
