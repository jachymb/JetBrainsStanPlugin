...
public class StanTruncationImpl extends ASTWrapperPsiElement implements StanTruncation {

  public StanTruncationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitTruncation(this);
  }
