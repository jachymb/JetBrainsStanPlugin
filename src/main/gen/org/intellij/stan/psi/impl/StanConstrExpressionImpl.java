...
public class StanConstrExpressionImpl extends ASTWrapperPsiElement implements StanConstrExpression {

  public StanConstrExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitConstrExpression(this);
  }
