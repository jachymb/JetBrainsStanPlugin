...
public class StanAssignmentStmtImpl extends ASTWrapperPsiElement implements StanAssignmentStmt {

  public StanAssignmentStmtImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StanAssignmentOp getAssignmentOp() {
    return findNotNullChildByClass(StanAssignmentOp.class);
  }
