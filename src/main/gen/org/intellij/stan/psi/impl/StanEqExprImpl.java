...
public class StanEqExprImpl extends ASTWrapperPsiElement implements StanEqExpr {

  public StanEqExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public StanEqExpr getEqExpr() {
    return findChildByClass(StanEqExpr.class);
  }

  @Override
  @NotNull
  public StanRelExpr getRelExpr() {
    return findNotNullChildByClass(StanRelExpr.class);
  }
