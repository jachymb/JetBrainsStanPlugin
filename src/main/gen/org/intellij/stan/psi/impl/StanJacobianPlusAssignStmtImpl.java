...
public class StanJacobianPlusAssignStmtImpl extends ASTWrapperPsiElement implements StanJacobianPlusAssignStmt {

  public StanJacobianPlusAssignStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitJacobianPlusAssignStmt(this);
  }
