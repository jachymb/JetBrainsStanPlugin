...
public class StanAddExprImpl extends ASTWrapperPsiElement implements StanAddExpr {

  public StanAddExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public StanAddExpr getAddExpr() {
    return findChildByClass(StanAddExpr.class);
  }

  @Override
  @NotNull
  public StanMulExpr getMulExpr() {
    return findNotNullChildByClass(StanMulExpr.class);
  }
