...
public class StanTildeStmtImpl extends ASTWrapperPsiElement implements StanTildeStmt {

  public StanTildeStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitTildeStmt(this);
  }
  ...
  @Override
  @Nullable
  public StanTruncation getTruncation() {
    return findChildByClass(StanTruncation.class);
  }
