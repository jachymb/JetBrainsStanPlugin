...
public class StanDeclaredVarImpl extends ASTWrapperPsiElement implements StanDeclaredVar {

  public StanDeclaredVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitDeclaredVar(this);
  }
