...
public class StanEmptyRowVectorExprImpl extends ASTWrapperPsiElement implements StanEmptyRowVectorExpr {

  public StanEmptyRowVectorExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StanVisitor visitor) {
    visitor.visitEmptyRowVectorExpr(this);
  }
